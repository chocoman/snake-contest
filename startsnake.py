...
from participants import martin, ester, frantisek, jana, sarka, tobias
from participants import laura, dominika, kylian, marie, martinvrba, prokop, adam, filip
...
game.add_ai_player('Dominika', '#33ff33', dominika.AI())

...
class AI:
  ...
  def decide_direction(self, fields):
    ...
    if self.is_free(head_row, head_col, RIGHT):
      return RIGHT
    if self.is_free(head_row, head_col, RIGHT) and self.is_free(head_row, head_col, RIGHTPLUS):
      return RIGHT

    elif self.is_free(head_row, head_col, LEFT):
      return LEFT
    elif self.is_free(head_row, head_col, LEFT) and self.is_free(head_row, head_col, LEFTPLUS):
      return LEFT

    elif self.is_free(head_row, head_col, UP):
      return UP
    elif self.is_free(head_row, head_col, UP) and self.is_free(head_row, head_col, UPPLUS):
      return UP

    elif self.is_free(head_row, head_col, DOWN):
      return DOWN
    elif self.is_free(head_row, head_col, DOWN) and self.is_free(head_row, head_col, DOWNPLUS):
      return DOWN
